...
public class DirectLoopAnalyzerTest {
  ...
  public void testDirectLoopAnalyzerMaybeResult() throws AnalyzerInterruptedException {
    Result res = (new DirectLoopAnalyzer(createTerminatingTermRewritingSystem())).analyze(30);
    assertEquals(Result.ResultType.MAYBE, res.getResultType());

    res = (new DirectLoopAnalyzer(createNonTerminatingTermRewritingSystem2())).analyze(30);
    assertEquals(Result.ResultType.MAYBE, res.getResultType());
  }

  @Test
  public void testDirectLoopAnalyzerTimeoutResult() throws AnalyzerInterruptedException {
    Result res = (new DirectLoopAnalyzer(createTerminatingTermRewritingSystem())).analyze(0);
