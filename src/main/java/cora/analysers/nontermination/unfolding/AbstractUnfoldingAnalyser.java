...
import cora.analysers.nontermination.unfolding.functionalgraph.FunctionalDependencyGraph;
 ...
 */
public class AbstractUnfoldingAnalyser extends UnfoldingAnalyser {
  /**
   ...
   */
  public AbstractUnfoldingAnalyser(TRS trs) {
    this(trs, 5, new SemiUnification(), true);
  }

  public AbstractUnfoldingAnalyser(TRS trs, int maxUnfoldings, SemiUnifier semiUnifier, boolean augmentTrs) {
