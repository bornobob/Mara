 ...
 */
public abstract class UnfoldingAnalyser extends InterruptableAnalyzer
{
  TRS _trs;
  int _maximumUnfoldings;
  SemiUnifier _semiUnifier;

  protected UnfoldingAnalyser(TRS trs, int maximumUnfoldings, SemiUnifier semiUnifier) {
